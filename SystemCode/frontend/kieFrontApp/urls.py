...
urlpatterns = [
    ...
    url(r'^viewRecommand/$', views.ShowRecommandResultView.as_view(), name='viewRecommand'),
    url(r'^createRecommand/$', views.CreateRecommandationView.as_view(), name='createRecommand'),
